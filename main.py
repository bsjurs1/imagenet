...
class Net(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.conv1(x)
        # print("Size after conv1 is: ")
        # print(x.size())

        x = F.max_pool2d(x, 2)
        # print("Size after avg_pool is: ")
        # print(x.size())

        x = F.relu(x)
        # print("Size after relu 1 is: ")
        # print(x.size())

        x = self.conv2(x)
        # print("Size after conv2 is: ")
        # print(x.size())

        x = F.max_pool2d(x, 2)
        # print("Size after max_pool2d is: ")
        # print(x.size())
        ...
        x = self.conv3(x)
        # print("size after conv3 is: ")
        # print(x.size())

        x = x.view(-1, 2430)
        # print("size after view is: ")
        # print(x.size())

        x = self.fc1(x)
        # print("size after fc1 is: ")
        # print(x.size())

        x = F.relu(x)
        # print("size after relu is: ")
        # print(x.size())
        x = F.dropout(x, training=self.training)
        # print("size after drop out is: ")
        # print(x.size())
        x = self.fc2(x)
        # print("size after fc2 is: ")
        # print(x.size())
